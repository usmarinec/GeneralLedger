...
@Schema(
    name = "CreateFiscalYearRequest",
    description = "Request body for creating a fiscal year for an accounting entity.")
public record CreateFiscalYearRequest(
    @Schema(
            description = "UUID of the accounting entity that owns the fiscal year.",
